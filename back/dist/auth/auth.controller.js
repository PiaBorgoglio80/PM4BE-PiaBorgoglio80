...
const userDto_1 = require("../users/dtos/userDto");
let AuthController = class AuthController {
    ...
    signUp(user) {
        const { confirmPassword, ...userWithoutPasswordConfirm } = user;
        return this.authService.signUp(userWithoutPasswordConfirm);
    }
};
